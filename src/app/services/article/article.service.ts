...
export class ArticleService {
  ...
  updateArticle(article: Article): void {
    this.articleCollection.doc(article.$key).update({ title: article.title, image: article.image,price: article.price, details: article.details, category: article.category });
  }
